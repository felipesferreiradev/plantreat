...
ActiveRecord::Schema[7.0].define(version: 2022_09_15_082926) do
  ...
  create_table "plants", force: :cascade do |t|
    ...
    t.string "light"
    t.string "humidity"
    t.string "plants_images"
    t.string "plant_image_2"
    t.string "plant_image_3"
  end
  ...
  create_table "user_histories", force: :cascade do |t|
    ...
    t.index ["log_id"], name: "index_user_histories_on_log_id"
  ...
  add_foreign_key "user_histories", "logs"
